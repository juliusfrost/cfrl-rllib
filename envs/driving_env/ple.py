...
class PLE(object):
    ...
    def __init__(self,
        ...
        if isinstance(self.game, PyGameWrapper):
            ...
            from sac.envs.ple.games.doomwrapper import DoomWrapper
    ...
    def getActionSet(self):
        ...
        if self.add_noop_action and not self.game.continuous_actions:
    ...
    def _oneStepAct(self, action):
        ...
        if not self.game.continuous_actions and action not in self.getActionSet():
            action = self.NOOP
